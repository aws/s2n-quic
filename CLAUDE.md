...
- Use `S2N_LOG={level}` environment variable to change logging level. For debugging individual tests, prefer using `trace` since it will provide the most insight into what's happening.
