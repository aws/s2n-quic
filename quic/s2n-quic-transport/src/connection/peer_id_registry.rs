...
pub struct PeerIdRegistry {
    ...
    /// The random Destination Connection Id the Client uses for prior to Server response.
...
impl PeerIdRegistry {
    ...
    /// Set the randomly generated initial DestinationConnectionId generated by the client.
    pub(crate) fn set_original_destination_connection_id(&mut self, peer_id: connection::PeerId) {
        self.original_destination_connection_id = Some(peer_id);
    }

    /// Retrieve the randomly generated initial DestinationConnectionId generated by the client.
    pub(crate) fn original_destination_connection_id(&self) -> Option<connection::PeerId> {
