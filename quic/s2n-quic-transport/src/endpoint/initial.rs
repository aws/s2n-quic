...
impl<Config: endpoint::Config> endpoint::Endpoint<Config> {
    pub(super) fn handle_initial_packet(
        ...
        odcid: Option<connection::InitialId>,
        ...
        // The destination connection ID on the first packet in the datagram
        ...
        if let Some(original_cid) = odcid {
            original_destination_connection_id = original_cid;
            ...
            initial_connection_id = destination_connection_id;
        } else {
            ...
            original_destination_connection_id =
                destination_connection_id.try_into().map_err(|_| {
