...
pub struct Manager<Config: endpoint::Config> {
    ...
    //= https://www.rfc-editor.org/rfc/rfc9002#A.3
    ...
    //= https://www.rfc-editor.org/rfc/rfc9002#6.2
...
//= https://www.rfc-editor.org/rfc/rfc9002#6.1.1
...
impl<Config: endpoint::Config> Manager<Config> {
    ...
    pub fn update_pto_timer(
        ...
        //= https://www.rfc-editor.org/rfc/rfc9002#6.2.2.1
    ...
    >(
        ...
        //= https://www.rfc-editor.org/rfc/rfc9002#5.1
    ...
    fn update_congestion_control<A: frame::ack::AckRanges, Ctx: Context<Config>>(
        ...
        //= https://www.rfc-editor.org/rfc/rfc9000#9.4
    ...
    >(
        ...
        //= https://www.rfc-editor.org/rfc/rfc9002#6.1.2
    ...
    fn process_ecn<Ctx: Context<Config>, Pub: event::ConnectionPublisher>(
        ...
        if matches!(outcome, ValidationOutcome::CongestionExperienced) {
            //= https://www.rfc-editor.org/rfc/rfc9002#7.1
    ...
    //= https://www.rfc-editor.org/rfc/rfc9002#B.9
    ...
    fn detect_lost_packets<Ctx: Context<Config>, Pub: event::ConnectionPublisher>(
        ...
        for (unacked_packet_number, unacked_sent_info) in self.sent_packets.iter() {
            ...
            //= https://www.rfc-editor.org/rfc/rfc9002#6.1
    ...
    fn remove_lost_packets<Ctx: Context<Config>, Pub: event::ConnectionPublisher>(
        ...
        for (packet_number, sent_info) in sent_packets_to_remove {
            ...
            if persistent_congestion {
                //= https://www.rfc-editor.org/rfc/rfc9002#5.2
    ...
    pub fn on_transmit<W: WriteContext>(&mut self, context: &mut W) {
        ...
        match self.state {
            ...
            PtoState::RequiresTransmission(remaining) => {
                ...
                //= https://www.rfc-editor.org/rfc/rfc9002#A.9
