...
impl Manager {
    ...
    >(
        ...
        let (largest_newly_acked_packet_number, largest_newly_acked_info) =
            largest_newly_acked.expect("There are newly acked packets");
        ...
        should_update_rtt &= largest_newly_acked_packet_number == largest_acked_in_frame;
    ...
    fn detect_and_remove_lost_packets<CC: CongestionController, Ctx: Context<CC>>(
        ...
        for (unacked_packet_number, unacked_sent_info) in self.sent_packets.iter() {
            ...
            if context.path_mut_by_id(unacked_sent_info.path_id)
                .rtt_estimator
                .first_rtt_sample()
...
mod test {
    ...
    fn on_ack_frame() {
        ...
        context.path_manager_mut()[path::Id::new(0)] = Path::new(
            Default::default(),
            connection::PeerId::TEST_ID,
            connection::LocalId::TEST_ID,
    ...
    fn persistent_congestion_period_does_not_start_until_rtt_sample() {
        ...
        //         now, at t=20.1
        let datagram = DatagramInfo {
            timestamp: time_zero + Duration::from_millis(20100),
            remote_address: Default::default(),
            payload_len: 0,
            ecn: Default::default(),
            destination_connection_id: connection::LocalId::TEST_ID,
    ...
    fn update_pto_timer() {
        ...
        context.path_manager_mut()[path::Id::new(0)] = path;
    ...
    impl<'a> recovery::Context<Endpoint> for MockContext<'a> {
        ...
        fn path_manager_mut(&mut self) -> &mut path::Manager<Endpoint> {
