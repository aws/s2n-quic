...
impl Controller {
    ...
    /// Returns a randomly generated number of packets to send before an ECN-CE marked packet should
    /// be sent, to test if CE reports are being suppressed by the peer.
    ///
    ...
    fn next_ce_packet_count<Rnd: random::Generator>(random_generator: &mut Rnd) -> u16 {
        ...
        u16::from_be_bytes(bytes) % CE_SUPPRESSION_TESTING_MAX_PACKET_COUNT
    }
