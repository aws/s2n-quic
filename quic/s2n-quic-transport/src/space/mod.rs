...
pub trait PacketSpace<Config: endpoint::Config> {
    ...
    fn handle_cleartext_payload<'a, Pub: event::ConnectionPublisher>(
        ...
        while !payload.is_empty() {
            ...
            match frame {
                Frame::Padding(frame) => {
                    //= https://www.rfc-editor.org/rfc/rfc9000#19.1
                ...
                Frame::Ping(frame) => {
                    //= https://www.rfc-editor.org/rfc/rfc9000#19.2
                ...
                Frame::PathChallenge(frame) => {
                    ...
                    //= https://www.rfc-editor.org/rfc/rfc9000#9.3.3
        ...
        //= https://www.rfc-editor.org/rfc/rfc9000#12.4
