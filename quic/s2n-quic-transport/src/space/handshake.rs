...
pub struct HandshakeSpace<Config: endpoint::Config> {
    ...
    pub crypto: <<Config::TLSEndpoint as tls::Endpoint>::Session as CryptoSuite>::HandshakeCrypto,
...
impl<Config: endpoint::Config> HandshakeSpace<Config> {
    pub fn new(
        crypto: <<Config::TLSEndpoint as tls::Endpoint>::Session as CryptoSuite>::HandshakeCrypto,
        now: Timestamp,
