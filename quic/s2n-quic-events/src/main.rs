...
impl EventInfo<'_> {
    ...
    // Generate an events framework for testing purposes, to ensure that the code generated by
    // s2n-quic-events is correct. This events framework is used by the s2n-quic-events unit tests,
