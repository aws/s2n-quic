...
use crate::{
    ...
    stream::{
        self,
        limits::{LocalBiDirectionalLimit, LocalMaxSendBufferSize, LocalUniDirectionalLimit},
    },
...
pub struct Limits {
    ...
    pub(crate) max_open_local_bidirectional_streams: Option<LocalBiDirectionalLimit>,
