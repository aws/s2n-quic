...
//= https://www.rfc-editor.org/rfc/rfc9002#7.3
//#                 New Path or      +------------+
...
//= https://www.rfc-editor.org/rfc/rfc9002#7.3.2
...
impl CongestionAvoidanceTiming {
    //= https://www.rfc-editor.org/rfc/rfc8312#4.1
    ...
    fn on_window_increase(&mut self, timestamp: Timestamp) {
        if let Some(app_limited_time) = self.app_limited_time.take() {
            //= https://www.rfc-editor.org/rfc/rfc8312#5.8
...
pub struct CubicCongestionController {
    cubic: Cubic,
    //= https://www.rfc-editor.org/rfc/rfc8312#4.8
    ...
    state: State,
    //= https://www.rfc-editor.org/rfc/rfc9002#B.2
...
impl CongestionController for CubicCongestionController {
    ...
    fn on_packet_ack(
        ...
        if self.under_utilized {
            ...
            //= https://www.rfc-editor.org/rfc/rfc9002#7.8
        ...
        match self.state {
            SlowStart => {
                //= https://www.rfc-editor.org/rfc/rfc9002#7.3.1
    ...
    fn on_congestion_event(&mut self, event_time: Timestamp) {
        ...
        //= https://www.rfc-editor.org/rfc/rfc9002#7.2
    ...
    //= https://www.rfc-editor.org/rfc/rfc9002#6.4
...
impl CubicCongestionController {
    ...
    fn congestion_avoidance(&mut self, t: Duration, rtt: Duration, sent_bytes: usize) {
        ...
        if w_cubic < w_est {
            // TCP-Friendly Region
            //= https://www.rfc-editor.org/rfc/rfc8312#4.2
            ...
            // Concave Region
            //= https://www.rfc-editor.org/rfc/rfc8312#4.3
            ...
            // Convex Region
            //# https://www.rfc-editor.org/rfc/rfc8312#4.4
            //# When receiving an ACK in congestion avoidance, if CUBIC is not in the
...
struct Cubic {
    ...
    w_max: f32,
    //= https://www.rfc-editor.org/rfc/rfc8312#4.6
...
//= https://www.rfc-editor.org/rfc/rfc8312#5.1
...
//= https://www.rfc-editor.org/rfc/rfc8312#4.5
