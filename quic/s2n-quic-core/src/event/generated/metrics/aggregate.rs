...
pub struct Subscriber<R: Registry> {
    ...
    #[allow(dead_code)]
    nominal_counter_offsets: Box<[usize; 17usize]>,
    #[allow(dead_code)]
...
impl<R: Registry> Subscriber<R> {
    ...
    pub fn new(registry: R) -> Self {
        ...
        let mut nominal_counter_offsets = Vec::with_capacity(17usize);
        ...
        bool_counters.push(registry.register_bool_counter(&INFO[85usize]));
        {
            ...
            }
            {
                ...
                for variant in <DatagramDropReason as AsVariant>::VARIANTS.iter() {
                    nominal_counters
                        .push(registry.register_nominal_counter(&INFO[116usize], variant));
                    count += 1;
                }
                debug_assert_ne!(count, 0, "field type needs at least one variant");
                nominal_counter_offsets.push(offset);
        ...
        timers.push(registry.register_timer(&INFO[67usize]));
        ...
        timers.push(registry.register_timer(&INFO[100usize]));
        ...
        timers.push(registry.register_timer(&INFO[146usize]));
        {
            ...
            use api::*;
            {
                ...
                let mut count = 0;
                for variant in <SlowStartExitCause as AsVariant>::VARIANTS.iter() {
                    nominal_timers.push(registry.register_nominal_timer(&INFO[88usize], variant));
                    count += 1;
                }
                debug_assert_ne!(count, 0, "field type needs at least one variant");
    ...
    pub fn counters(&self) -> impl Iterator<Item = (&'static Info, &R::Counter)> + '_ {
        self.counters
            ...
            .map(|(idx, entry)| match idx {
                ...
                20usize => (&INFO[40usize], entry),
                21usize => (&INFO[41usize], entry),
                22usize => (&INFO[44usize], entry),
                23usize => (&INFO[46usize], entry),
                24usize => (&INFO[48usize], entry),
                25usize => (&INFO[49usize], entry),
                26usize => (&INFO[52usize], entry),
                27usize => (&INFO[53usize], entry),
                28usize => (&INFO[55usize], entry),
                29usize => (&INFO[56usize], entry),
                30usize => (&INFO[59usize], entry),
                31usize => (&INFO[60usize], entry),
                32usize => (&INFO[62usize], entry),
                33usize => (&INFO[64usize], entry),
                34usize => (&INFO[69usize], entry),
                35usize => (&INFO[70usize], entry),
                36usize => (&INFO[71usize], entry),
                37usize => (&INFO[73usize], entry),
                38usize => (&INFO[75usize], entry),
                39usize => (&INFO[76usize], entry),
                40usize => (&INFO[78usize], entry),
                41usize => (&INFO[79usize], entry),
                42usize => (&INFO[81usize], entry),
                43usize => (&INFO[82usize], entry),
                44usize => (&INFO[86usize], entry),
                45usize => (&INFO[90usize], entry),
                46usize => (&INFO[91usize], entry),
                47usize => (&INFO[95usize], entry),
                48usize => (&INFO[97usize], entry),
                49usize => (&INFO[103usize], entry),
                50usize => (&INFO[104usize], entry),
                51usize => (&INFO[105usize], entry),
                52usize => (&INFO[106usize], entry),
                53usize => (&INFO[110usize], entry),
                54usize => (&INFO[113usize], entry),
                55usize => (&INFO[117usize], entry),
                56usize => (&INFO[119usize], entry),
                57usize => (&INFO[120usize], entry),
                58usize => (&INFO[122usize], entry),
                59usize => (&INFO[124usize], entry),
                60usize => (&INFO[126usize], entry),
                61usize => (&INFO[128usize], entry),
                62usize => (&INFO[130usize], entry),
                63usize => (&INFO[131usize], entry),
                64usize => (&INFO[132usize], entry),
                65usize => (&INFO[134usize], entry),
                66usize => (&INFO[136usize], entry),
                67usize => (&INFO[138usize], entry),
                68usize => (&INFO[140usize], entry),
                69usize => (&INFO[142usize], entry),
                70usize => (&INFO[143usize], entry),
                71usize => (&INFO[144usize], entry),
                72usize => (&INFO[145usize], entry),
                73usize => (&INFO[147usize], entry),
        ...
        self.nominal_counter_offsets
            ...
            .map(|(idx, entry)| match idx {
                ...
                15usize => {
                    ...
                    let variants = <DatagramDropReason as AsVariant>::VARIANTS;
                    let entries = &self.nominal_counters[offset..offset + variants.len()];
                    (&INFO[116usize], entries, variants)
                }
                16usize => {
                    let offset = *entry;
                    let variants = <crate::connection::Error as AsVariant>::VARIANTS;
    ...
    pub fn measures(&self) -> impl Iterator<Item = (&'static Info, &R::Measure)> + '_ {
        self.measures
            ...
            .map(|(idx, entry)| match idx {
                ...
                10usize => (&INFO[50usize], entry),
                11usize => (&INFO[51usize], entry),
                12usize => (&INFO[54usize], entry),
                13usize => (&INFO[57usize], entry),
                14usize => (&INFO[77usize], entry),
                15usize => (&INFO[80usize], entry),
                16usize => (&INFO[83usize], entry),
                17usize => (&INFO[89usize], entry),
                18usize => (&INFO[92usize], entry),
                19usize => (&INFO[93usize], entry),
                20usize => (&INFO[94usize], entry),
                21usize => (&INFO[107usize], entry),
                22usize => (&INFO[108usize], entry),
                23usize => (&INFO[109usize], entry),
                24usize => (&INFO[111usize], entry),
                25usize => (&INFO[112usize], entry),
                26usize => (&INFO[114usize], entry),
                27usize => (&INFO[115usize], entry),
                28usize => (&INFO[121usize], entry),
                29usize => (&INFO[123usize], entry),
                30usize => (&INFO[125usize], entry),
                31usize => (&INFO[127usize], entry),
                32usize => (&INFO[129usize], entry),
                33usize => (&INFO[133usize], entry),
                34usize => (&INFO[135usize], entry),
                35usize => (&INFO[137usize], entry),
                36usize => (&INFO[139usize], entry),
                37usize => (&INFO[141usize], entry),
                _ => unsafe { core::hint::unreachable_unchecked() },
            })
    }
    #[allow(dead_code)]
    ...
    pub fn timers(&self) -> impl Iterator<Item = (&'static Info, &R::Timer)> + '_ {
        self.timers
            ...
            .enumerate()
            .map(|(idx, entry)| match idx {
                0usize => (&INFO[36usize], entry),
                1usize => (&INFO[37usize], entry),
                2usize => (&INFO[38usize], entry),
                3usize => (&INFO[42usize], entry),
                4usize => (&INFO[47usize], entry),
                5usize => (&INFO[65usize], entry),
                6usize => (&INFO[66usize], entry),
                7usize => (&INFO[67usize], entry),
                8usize => (&INFO[72usize], entry),
                9usize => (&INFO[74usize], entry),
                10usize => (&INFO[98usize], entry),
                11usize => (&INFO[99usize], entry),
                12usize => (&INFO[100usize], entry),
                13usize => (&INFO[101usize], entry),
                14usize => (&INFO[146usize], entry),
                _ => unsafe { core::hint::unreachable_unchecked() },
            })
    }
    #[allow(dead_code)]
...
impl<R: Registry> event::Subscriber for Subscriber<R> {
    ...
    fn on_key_space_discarded(
        ...
        self.count_nominal(39usize, 4usize, &event.space);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_connection_started(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(40usize, 20usize, 1usize);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_connection_closed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(41usize, 21usize, 1usize);
        self.time(
            42usize,
            3usize,
            meta.timestamp.saturating_duration_since(context.start_time),
        );
        self.count_nominal(43usize, 5usize, &event.error);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_duplicate_packet(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(44usize, 22usize, 1usize);
        self.count_nominal(45usize, 6usize, &event.error);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_transport_parameters_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(46usize, 23usize, 1usize);
        self.time(
            47usize,
            4usize,
            meta.timestamp.saturating_duration_since(context.start_time),
    ...
    fn on_datagram_sent(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(48usize, 24usize, 1usize);
        self.count(49usize, 25usize, event.len);
        self.measure(50usize, 10usize, event.len);
        self.measure(51usize, 11usize, event.gso_offset);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_datagram_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(52usize, 26usize, 1usize);
        self.count(53usize, 27usize, event.len);
        self.measure(54usize, 12usize, event.len);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_datagram_dropped(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(55usize, 28usize, 1usize);
        self.count(56usize, 29usize, event.len);
        self.measure(57usize, 13usize, event.len);
        self.count_nominal(58usize, 7usize, &event.reason);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_connection_id_updated(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(59usize, 30usize, 1usize);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_ecn_state_changed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(60usize, 31usize, 1usize);
        self.count_nominal(61usize, 8usize, &event.state);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_connection_migration_denied(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(62usize, 32usize, 1usize);
        self.count_nominal(63usize, 9usize, &event.reason);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_handshake_status_updated(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(64usize, 33usize, 1usize);
        {
        ...
        self.count_nominal(68usize, 10usize, &event.status);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_tls_exporter_ready(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(69usize, 34usize, 1usize);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_path_challenge_updated(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(70usize, 35usize, 1usize);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_tls_client_hello(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(71usize, 36usize, 1usize);
        self.time(
            72usize,
            8usize,
            meta.timestamp.saturating_duration_since(context.start_time),
    ...
    fn on_tls_server_hello(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(73usize, 37usize, 1usize);
        self.time(
            74usize,
            9usize,
            meta.timestamp.saturating_duration_since(context.start_time),
    ...
    fn on_rx_stream_progress(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(75usize, 38usize, 1usize);
        self.count(76usize, 39usize, event.bytes);
    ...
    fn on_tx_stream_progress(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(78usize, 40usize, 1usize);
        self.count(79usize, 41usize, event.bytes);
    ...
    fn on_keep_alive_timer_expired(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(81usize, 42usize, 1usize);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_mtu_updated(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(82usize, 43usize, 1usize);
        self.measure(83usize, 16usize, event.mtu);
        self.count_nominal(84usize, 11usize, &event.cause);
        self.count_bool(85usize, 2usize, event.search_complete);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_slow_start_exited(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(86usize, 44usize, 1usize);
        self.count_nominal(87usize, 12usize, &event.cause);
        self.time_nominal(
            88usize,
            0usize,
            &event.cause,
        ...
        self.measure(89usize, 17usize, event.congestion_window);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_delivery_rate_sampled(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(90usize, 45usize, 1usize);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_pacing_rate_updated(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(91usize, 46usize, 1usize);
        self.measure(92usize, 18usize, event.bytes_per_second);
        self.measure(93usize, 19usize, event.burst_size);
        self.measure(94usize, 20usize, event.pacing_gain);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_bbr_state_changed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(95usize, 47usize, 1usize);
        self.count_nominal(96usize, 13usize, &event.state);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_dc_state_changed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(97usize, 48usize, 1usize);
        {
        ...
        self.count_nominal(102usize, 14usize, &event.state);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_version_information(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(103usize, 49usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_packet_sent(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(104usize, 50usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_packet_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(105usize, 51usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_datagram_sent(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(106usize, 52usize, 1usize);
        self.measure(107usize, 21usize, event.len);
        self.measure(108usize, 22usize, event.len);
        self.measure(109usize, 23usize, event.gso_offset);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_datagram_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(110usize, 53usize, 1usize);
        self.measure(111usize, 24usize, event.len);
        self.measure(112usize, 25usize, event.len);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_datagram_dropped(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(113usize, 54usize, 1usize);
        self.measure(114usize, 26usize, event.len);
        self.measure(115usize, 27usize, event.len);
        self.count_nominal(116usize, 15usize, &event.reason);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_endpoint_connection_attempt_failed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(117usize, 55usize, 1usize);
        self.count_nominal(118usize, 16usize, &event.error);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_platform_tx(&mut self, meta: &api::EndpointMeta, event: &api::PlatformTx) {
        #[allow(unused_imports)]
        use api::*;
        self.count(119usize, 56usize, 1usize);
        self.count(120usize, 57usize, event.count);
        self.measure(121usize, 28usize, event.count);
        self.count(122usize, 58usize, event.syscalls);
        self.measure(123usize, 29usize, event.syscalls);
        self.count(124usize, 59usize, event.blocked_syscalls);
        self.measure(125usize, 30usize, event.blocked_syscalls);
        self.count(126usize, 60usize, event.total_errors);
        self.measure(127usize, 31usize, event.total_errors);
        self.count(128usize, 61usize, event.dropped_errors);
        self.measure(129usize, 32usize, event.dropped_errors);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_platform_tx_error(&mut self, meta: &api::EndpointMeta, event: &api::PlatformTxError) {
        #[allow(unused_imports)]
        use api::*;
        self.count(130usize, 62usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_platform_rx(&mut self, meta: &api::EndpointMeta, event: &api::PlatformRx) {
        #[allow(unused_imports)]
        use api::*;
        self.count(131usize, 63usize, 1usize);
        self.count(132usize, 64usize, event.count);
        self.measure(133usize, 33usize, event.count);
        self.count(134usize, 65usize, event.syscalls);
        self.measure(135usize, 34usize, event.syscalls);
        self.count(136usize, 66usize, event.blocked_syscalls);
        self.measure(137usize, 35usize, event.blocked_syscalls);
        self.count(138usize, 67usize, event.total_errors);
        self.measure(139usize, 36usize, event.total_errors);
        self.count(140usize, 68usize, event.dropped_errors);
        self.measure(141usize, 37usize, event.dropped_errors);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_platform_rx_error(&mut self, meta: &api::EndpointMeta, event: &api::PlatformRxError) {
        #[allow(unused_imports)]
        use api::*;
        self.count(142usize, 69usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_platform_feature_configured(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(143usize, 70usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_platform_event_loop_wakeup(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(144usize, 71usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_platform_event_loop_sleep(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(145usize, 72usize, 1usize);
        self.time(146usize, 14usize, event.processing_duration);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_platform_event_loop_started(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(147usize, 73usize, 1usize);
        let _ = event;
        let _ = meta;
    }
}
