...
impl DescriptorInner {
    ...
    fn free(&self, desc: &Descriptor) {
        ...
        let _ = unsafe { Box::from_raw(self.memory.as_ptr()) };
    }
}
...
impl Filled {
    ...
    pub fn payload(&self) -> &[u8] {
        unsafe {
            let ptr = self.desc.data().add(self.offset as _);
