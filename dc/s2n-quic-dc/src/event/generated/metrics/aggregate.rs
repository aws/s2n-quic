...
impl<R: Registry> Subscriber<R> {
    ...
    pub fn new(registry: R) -> Self {
        ...
        let mut timers = Vec::with_capacity(22usize);
        ...
        bool_counters.push(registry.register_bool_counter(&INFO[47usize]));
        ...
        bool_counters.push(registry.register_bool_counter(&INFO[155usize]));
        ...
        bool_counters.push(registry.register_bool_counter(&INFO[188usize]));
        ...
        bool_counters.push(registry.register_bool_counter(&INFO[211usize]));
        bool_counters.push(registry.register_bool_counter(&INFO[212usize]));
        bool_counters.push(registry.register_bool_counter(&INFO[273usize]));
        bool_counters.push(registry.register_bool_counter(&INFO[278usize]));
        {
            ...
            }
            {
                ...
                for variant in <AcceptorPacketDropReason as AsVariant>::VARIANTS.iter() {
                    nominal_counters
                        .push(registry.register_nominal_counter(&INFO[24usize], variant));
                    count += 1;
                }
                debug_assert_ne!(count, 0, "field type needs at least one variant");
                nominal_counter_offsets.push(offset);
            ...
            }
            {
                ...
                for variant in <SocketAddress as AsVariant>::VARIANTS.iter() {
                    nominal_counters
                        .push(registry.register_nominal_counter(&INFO[209usize], variant));
                    count += 1;
                }
                debug_assert_ne!(count, 0, "field type needs at least one variant");
                nominal_counter_offsets.push(offset);
        ...
        timers.push(registry.register_timer(&INFO[153usize]));
        timers.push(registry.register_timer(&INFO[160usize]));
        {
            #[allow(unused_imports)]
            use api::*;
        }
    ...
    pub fn counters(&self) -> impl Iterator<Item = (&'static Info, &R::Counter)> + '_ {
        self.counters
            ...
            .map(|(idx, entry)| match idx {
                ...
                16usize => (&INFO[48usize], entry),
                17usize => (&INFO[50usize], entry),
                18usize => (&INFO[51usize], entry),
                19usize => (&INFO[52usize], entry),
                20usize => (&INFO[55usize], entry),
                21usize => (&INFO[58usize], entry),
                22usize => (&INFO[62usize], entry),
                23usize => (&INFO[67usize], entry),
                24usize => (&INFO[71usize], entry),
                25usize => (&INFO[76usize], entry),
                26usize => (&INFO[82usize], entry),
                27usize => (&INFO[87usize], entry),
                28usize => (&INFO[88usize], entry),
                29usize => (&INFO[92usize], entry),
                30usize => (&INFO[96usize], entry),
                31usize => (&INFO[99usize], entry),
                32usize => (&INFO[102usize], entry),
                33usize => (&INFO[105usize], entry),
                34usize => (&INFO[107usize], entry),
                35usize => (&INFO[111usize], entry),
                36usize => (&INFO[116usize], entry),
                37usize => (&INFO[122usize], entry),
                38usize => (&INFO[127usize], entry),
                39usize => (&INFO[132usize], entry),
                40usize => (&INFO[133usize], entry),
                41usize => (&INFO[136usize], entry),
                42usize => (&INFO[139usize], entry),
                43usize => (&INFO[142usize], entry),
                44usize => (&INFO[145usize], entry),
                45usize => (&INFO[147usize], entry),
                46usize => (&INFO[151usize], entry),
                47usize => (&INFO[154usize], entry),
                48usize => (&INFO[158usize], entry),
                49usize => (&INFO[161usize], entry),
                50usize => (&INFO[163usize], entry),
                51usize => (&INFO[167usize], entry),
                52usize => (&INFO[169usize], entry),
                53usize => (&INFO[171usize], entry),
                54usize => (&INFO[175usize], entry),
                55usize => (&INFO[177usize], entry),
                56usize => (&INFO[182usize], entry),
                57usize => (&INFO[184usize], entry),
                58usize => (&INFO[189usize], entry),
                59usize => (&INFO[191usize], entry),
                60usize => (&INFO[195usize], entry),
                61usize => (&INFO[196usize], entry),
                62usize => (&INFO[198usize], entry),
                63usize => (&INFO[201usize], entry),
                64usize => (&INFO[205usize], entry),
                65usize => (&INFO[206usize], entry),
                66usize => (&INFO[207usize], entry),
                67usize => (&INFO[208usize], entry),
                68usize => (&INFO[213usize], entry),
                69usize => (&INFO[215usize], entry),
                70usize => (&INFO[217usize], entry),
                71usize => (&INFO[221usize], entry),
                72usize => (&INFO[223usize], entry),
                73usize => (&INFO[225usize], entry),
                74usize => (&INFO[227usize], entry),
                75usize => (&INFO[229usize], entry),
                76usize => (&INFO[232usize], entry),
                77usize => (&INFO[235usize], entry),
                78usize => (&INFO[237usize], entry),
                79usize => (&INFO[239usize], entry),
                80usize => (&INFO[241usize], entry),
                81usize => (&INFO[243usize], entry),
                82usize => (&INFO[245usize], entry),
                83usize => (&INFO[248usize], entry),
                84usize => (&INFO[249usize], entry),
                85usize => (&INFO[251usize], entry),
                86usize => (&INFO[253usize], entry),
                ...
                96usize => (&INFO[274usize], entry),
                97usize => (&INFO[277usize], entry),
                98usize => (&INFO[279usize], entry),
                99usize => (&INFO[281usize], entry),
    ...
    pub fn bool_counters(&self) -> impl Iterator<Item = (&'static Info, &R::BoolCounter)> + '_ {
        self.bool_counters
            ...
            .map(|(idx, entry)| match idx {
                ...
                2usize => (&INFO[44usize], entry),
                3usize => (&INFO[45usize], entry),
                4usize => (&INFO[46usize], entry),
                5usize => (&INFO[47usize], entry),
                6usize => (&INFO[95usize], entry),
                7usize => (&INFO[135usize], entry),
                8usize => (&INFO[148usize], entry),
                9usize => (&INFO[152usize], entry),
                10usize => (&INFO[155usize], entry),
                11usize => (&INFO[166usize], entry),
                12usize => (&INFO[174usize], entry),
                13usize => (&INFO[181usize], entry),
                14usize => (&INFO[188usize], entry),
                15usize => (&INFO[194usize], entry),
                16usize => (&INFO[204usize], entry),
                17usize => (&INFO[211usize], entry),
                18usize => (&INFO[212usize], entry),
                19usize => (&INFO[273usize], entry),
                20usize => (&INFO[278usize], entry),
                _ => unsafe { core::hint::unreachable_unchecked() },
            })
    }
    #[allow(dead_code)]
        ...
        self.nominal_counter_offsets
            ...
            .map(|(idx, entry)| match idx {
                ...
                8usize => {
                    ...
                    let entries = &self.nominal_counters[offset..offset + variants.len()];
                    (&INFO[209usize], entries, variants)
                }
                9usize => {
                    let offset = *entry;
                    let variants = <SocketAddress as AsVariant>::VARIANTS;
    ...
    pub fn measures(&self) -> impl Iterator<Item = (&'static Info, &R::Measure)> + '_ {
        self.measures
            ...
            .map(|(idx, entry)| match idx {
                ...
                72usize => (&INFO[164usize], entry),
                73usize => (&INFO[165usize], entry),
                74usize => (&INFO[168usize], entry),
                75usize => (&INFO[170usize], entry),
                76usize => (&INFO[172usize], entry),
                77usize => (&INFO[173usize], entry),
                78usize => (&INFO[176usize], entry),
                79usize => (&INFO[178usize], entry),
                80usize => (&INFO[179usize], entry),
                81usize => (&INFO[180usize], entry),
                82usize => (&INFO[183usize], entry),
                83usize => (&INFO[185usize], entry),
                84usize => (&INFO[186usize], entry),
                85usize => (&INFO[187usize], entry),
                86usize => (&INFO[190usize], entry),
                87usize => (&INFO[192usize], entry),
                88usize => (&INFO[193usize], entry),
                89usize => (&INFO[197usize], entry),
                90usize => (&INFO[199usize], entry),
                91usize => (&INFO[200usize], entry),
                92usize => (&INFO[202usize], entry),
                93usize => (&INFO[203usize], entry),
                94usize => (&INFO[216usize], entry),
                95usize => (&INFO[218usize], entry),
                96usize => (&INFO[219usize], entry),
                97usize => (&INFO[220usize], entry),
                98usize => (&INFO[231usize], entry),
                99usize => (&INFO[234usize], entry),
                100usize => (&INFO[246usize], entry),
                101usize => (&INFO[247usize], entry),
                102usize => (&INFO[250usize], entry),
                103usize => (&INFO[276usize], entry),
                104usize => (&INFO[280usize], entry),
                105usize => (&INFO[282usize], entry),
                106usize => (&INFO[283usize], entry),
                107usize => (&INFO[284usize], entry),
                108usize => (&INFO[285usize], entry),
                109usize => (&INFO[286usize], entry),
                110usize => (&INFO[287usize], entry),
                111usize => (&INFO[288usize], entry),
                112usize => (&INFO[289usize], entry),
                113usize => (&INFO[290usize], entry),
                114usize => (&INFO[291usize], entry),
                115usize => (&INFO[292usize], entry),
                116usize => (&INFO[293usize], entry),
                117usize => (&INFO[294usize], entry),
                118usize => (&INFO[295usize], entry),
                119usize => (&INFO[296usize], entry),
                120usize => (&INFO[297usize], entry),
                121usize => (&INFO[299usize], entry),
                122usize => (&INFO[300usize], entry),
                123usize => (&INFO[302usize], entry),
                124usize => (&INFO[303usize], entry),
                _ => unsafe { core::hint::unreachable_unchecked() },
            })
    }
    #[allow(dead_code)]
    ...
    pub fn timers(&self) -> impl Iterator<Item = (&'static Info, &R::Timer)> + '_ {
        self.timers
            ...
            .map(|(idx, entry)| match idx {
                ...
                3usize => (&INFO[25usize], entry),
                4usize => (&INFO[27usize], entry),
                5usize => (&INFO[32usize], entry),
                6usize => (&INFO[37usize], entry),
                7usize => (&INFO[53usize], entry),
                8usize => (&INFO[56usize], entry),
                9usize => (&INFO[57usize], entry),
                10usize => (&INFO[59usize], entry),
                11usize => (&INFO[68usize], entry),
                12usize => (&INFO[77usize], entry),
                13usize => (&INFO[83usize], entry),
                14usize => (&INFO[93usize], entry),
                15usize => (&INFO[108usize], entry),
                16usize => (&INFO[117usize], entry),
                17usize => (&INFO[123usize], entry),
                18usize => (&INFO[128usize], entry),
                19usize => (&INFO[134usize], entry),
                20usize => (&INFO[153usize], entry),
                21usize => (&INFO[160usize], entry),
                _ => unsafe { core::hint::unreachable_unchecked() },
            })
    }
    #[allow(dead_code)]
...
impl<R: Registry> event::Subscriber for Subscriber<R> {
    ...
    fn on_acceptor_tcp_packet_dropped(
        ...
        self.count_nominal(24usize, 1usize, &event.reason);
        self.time(25usize, 3usize, event.sojourn_time);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_tcp_stream_enqueued(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(26usize, 8usize, 1usize);
        self.time(27usize, 4usize, event.sojourn_time);
        self.measure(28usize, 10usize, event.blocked_count);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_tcp_io_error(&self, meta: &api::EndpointMeta, event: &api::AcceptorTcpIoError) {
        #[allow(unused_imports)]
        use api::*;
        self.count(29usize, 9usize, 1usize);
        self.count_nominal(30usize, 2usize, &event.source);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_tcp_socket_sent(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(31usize, 10usize, 1usize);
        self.time(32usize, 5usize, event.sojourn_time);
        self.count(33usize, 11usize, event.blocked_count);
        self.measure(34usize, 11usize, event.blocked_count);
        self.measure(35usize, 12usize, event.payload_len);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_tcp_socket_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(36usize, 12usize, 1usize);
        self.time(37usize, 6usize, event.transfer_time);
    ...
    fn on_acceptor_udp_started(&self, meta: &api::EndpointMeta, event: &api::AcceptorUdpStarted) {
        #[allow(unused_imports)]
        use api::*;
        self.count(39usize, 13usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_udp_datagram_received(
        ...
        self.measure(41usize, 14usize, event.len);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_udp_packet_received(
        ...
        self.measure(43usize, 15usize, event.payload_len);
        self.count_bool(44usize, 2usize, event.is_zero_offset);
        self.count_bool(45usize, 3usize, event.is_retransmission);
        self.count_bool(46usize, 4usize, event.is_fin);
        self.count_bool(47usize, 5usize, event.is_fin_known);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_udp_packet_dropped(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(48usize, 16usize, 1usize);
    ...
    fn on_acceptor_udp_stream_enqueued(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(50usize, 17usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_udp_io_error(&self, meta: &api::EndpointMeta, event: &api::AcceptorUdpIoError) {
        #[allow(unused_imports)]
        use api::*;
        self.count(51usize, 18usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_stream_pruned(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(52usize, 19usize, 1usize);
        self.time(53usize, 7usize, event.sojourn_time);
        self.count_nominal(54usize, 4usize, &event.reason);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_acceptor_stream_dequeued(
        ...
        self.time(56usize, 8usize, event.sojourn_time);
        self.time(57usize, 9usize, event.queue_sojourn_time);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stream_write_flushed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(58usize, 21usize, 1usize);
        self.time(
            59usize,
            10usize,
        ...
        self.measure(61usize, 17usize, event.provided_len);
        self.count(62usize, 22usize, event.committed_len);
        self.measure(63usize, 18usize, event.committed_len);
        context
            .ctr_19
            .fetch_add(event.committed_len.as_u64(), Ordering::Relaxed);
        self.measure(65usize, 20usize, event.processing_duration);
        context
            .ctr_21
    ...
    fn on_stream_write_fin_flushed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(67usize, 23usize, 1usize);
        self.time(
            68usize,
            11usize,
            meta.timestamp.saturating_duration_since(context.start_time),
        ...
        self.measure(70usize, 23usize, event.provided_len);
        self.count(71usize, 24usize, event.committed_len);
        self.measure(72usize, 24usize, event.committed_len);
        context
            .ctr_25
            .fetch_add(event.committed_len.as_u64(), Ordering::Relaxed);
        self.measure(74usize, 26usize, event.processing_duration);
        context
            .ctr_27
            .fetch_add(event.processing_duration.as_u64(), Ordering::Relaxed);
        let _ = context;
    ...
    fn on_stream_write_blocked(
        ...
        self.measure(79usize, 29usize, event.provided_len);
        self.measure(80usize, 30usize, event.processing_duration);
        context
            .ctr_31
            .fetch_add(event.processing_duration.as_u64(), Ordering::Relaxed);
        let _ = context;
    ...
    fn on_stream_write_errored(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(82usize, 26usize, 1usize);
        self.time(
            83usize,
            13usize,
            meta.timestamp.saturating_duration_since(context.start_time),
        );
        self.measure(84usize, 32usize, event.provided_len);
        self.measure(85usize, 33usize, event.processing_duration);
        context
            .ctr_34
            .fetch_add(event.processing_duration.as_u64(), Ordering::Relaxed);
        let _ = context;
    ...
    fn on_stream_write_key_updated(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(87usize, 27usize, 1usize);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_write_allocated(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(88usize, 28usize, 1usize);
        context.ctr_35.fetch_add(1, Ordering::Relaxed);
        self.measure(90usize, 36usize, event.allocated_len);
        context
            .ctr_37
    ...
    fn on_stream_write_shutdown(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(92usize, 29usize, 1usize);
        self.time(
            93usize,
            14usize,
            meta.timestamp.saturating_duration_since(context.start_time),
        );
        self.measure(94usize, 38usize, event.buffer_len);
        self.count_bool(95usize, 6usize, event.background);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_write_socket_flushed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(96usize, 30usize, 1usize);
        context.ctr_39.fetch_add(1, Ordering::Relaxed);
        self.measure(98usize, 40usize, event.provided_len);
        self.count(99usize, 31usize, event.committed_len);
        self.measure(100usize, 41usize, event.committed_len);
        context
            .ctr_42
            .fetch_add(event.committed_len.as_u64(), Ordering::Relaxed);
        let _ = context;
    ...
    fn on_stream_write_socket_blocked(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(102usize, 32usize, 1usize);
    ...
    fn on_stream_write_socket_errored(
        ...
        self.measure(106usize, 45usize, event.provided_len);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_read_flushed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(107usize, 34usize, 1usize);
        self.time(
            108usize,
            15usize,
            meta.timestamp.saturating_duration_since(context.start_time),
        ...
        self.measure(110usize, 47usize, event.capacity);
        self.count(111usize, 35usize, event.committed_len);
        self.measure(112usize, 48usize, event.committed_len);
        context
            .ctr_49
            .fetch_add(event.committed_len.as_u64(), Ordering::Relaxed);
        self.measure(114usize, 50usize, event.processing_duration);
        context
            .ctr_51
            .fetch_add(event.processing_duration.as_u64(), Ordering::Relaxed);
        let _ = context;
    ...
    fn on_stream_read_fin_flushed(
        ...
        self.measure(119usize, 53usize, event.capacity);
        self.measure(120usize, 54usize, event.processing_duration);
        context
            .ctr_55
            .fetch_add(event.processing_duration.as_u64(), Ordering::Relaxed);
        let _ = context;
    ...
    fn on_stream_read_blocked(
        ...
        self.measure(124usize, 56usize, event.capacity);
        self.measure(125usize, 57usize, event.processing_duration);
        context
            .ctr_58
            .fetch_add(event.processing_duration.as_u64(), Ordering::Relaxed);
        let _ = context;
    ...
    fn on_stream_read_errored(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(127usize, 38usize, 1usize);
        self.time(
            128usize,
            18usize,
            meta.timestamp.saturating_duration_since(context.start_time),
        );
        self.measure(129usize, 59usize, event.capacity);
        self.measure(130usize, 60usize, event.processing_duration);
        context
            .ctr_61
            .fetch_add(event.processing_duration.as_u64(), Ordering::Relaxed);
        let _ = context;
    ...
    fn on_stream_read_key_updated(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(132usize, 39usize, 1usize);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_read_shutdown(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(133usize, 40usize, 1usize);
        self.time(
            134usize,
            19usize,
            meta.timestamp.saturating_duration_since(context.start_time),
        );
        self.count_bool(135usize, 7usize, event.background);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_read_socket_flushed(
        ...
        self.measure(138usize, 63usize, event.capacity);
        self.count(139usize, 42usize, event.committed_len);
        self.measure(140usize, 64usize, event.committed_len);
        context
            .ctr_65
            .fetch_add(event.committed_len.as_u64(), Ordering::Relaxed);
        let _ = context;
    ...
    fn on_stream_read_socket_errored(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(145usize, 44usize, 1usize);
        self.measure(146usize, 68usize, event.capacity);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_decrypt_packet(
        ...
        self.count_bool(148usize, 8usize, event.decrypted_in_place);
        self.measure(149usize, 69usize, event.forced_copy);
        self.measure(150usize, 70usize, event.required_application_buffer);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_tcp_connect(&self, meta: &api::EndpointMeta, event: &api::StreamTcpConnect) {
        ...
        self.count_bool(152usize, 9usize, event.error);
        self.time(153usize, 20usize, event.latency);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stream_connect(&self, meta: &api::EndpointMeta, event: &api::StreamConnect) {
        #[allow(unused_imports)]
        use api::*;
        self.count(154usize, 47usize, 1usize);
        self.count_bool(155usize, 10usize, event.error);
        self.count_nominal(156usize, 5usize, &event.tcp_success);
        self.count_nominal(157usize, 6usize, &event.handshake_success);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stream_connect_error(&self, meta: &api::EndpointMeta, event: &api::StreamConnectError) {
        #[allow(unused_imports)]
        use api::*;
        self.count(158usize, 48usize, 1usize);
        self.count_nominal(159usize, 7usize, &event.reason);
        self.time(160usize, 21usize, event.latency);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stream_packet_transmitted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(161usize, 49usize, 1usize);
        self.measure(162usize, 71usize, event.packet_len);
        self.count(163usize, 50usize, event.payload_len);
        self.measure(164usize, 72usize, event.payload_len);
        context
            .ctr_73
            .fetch_add(event.payload_len.as_u64(), Ordering::Relaxed);
        self.count_bool(166usize, 11usize, event.is_retransmission);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_probe_transmitted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(167usize, 51usize, 1usize);
    ...
    fn on_stream_packet_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(169usize, 52usize, 1usize);
        self.measure(170usize, 75usize, event.packet_len);
        self.count(171usize, 53usize, event.payload_len);
        self.measure(172usize, 76usize, event.payload_len);
        context
            .ctr_77
            .fetch_add(event.payload_len.as_u64(), Ordering::Relaxed);
        self.count_bool(174usize, 12usize, event.is_retransmission);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_packet_lost(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(175usize, 54usize, 1usize);
        self.measure(176usize, 78usize, event.packet_len);
        self.count(177usize, 55usize, event.payload_len);
        self.measure(178usize, 79usize, event.payload_len);
        context
            .ctr_80
            .fetch_add(event.payload_len.as_u64(), Ordering::Relaxed);
        self.measure(180usize, 81usize, event.lifetime);
        self.count_bool(181usize, 13usize, event.is_retransmission);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_packet_acked(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(182usize, 56usize, 1usize);
        self.measure(183usize, 82usize, event.packet_len);
        self.count(184usize, 57usize, event.payload_len);
        self.measure(185usize, 83usize, event.payload_len);
        context
            .ctr_84
            .fetch_add(event.payload_len.as_u64(), Ordering::Relaxed);
        self.measure(187usize, 85usize, event.lifetime);
        self.count_bool(188usize, 14usize, event.is_retransmission);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_packet_spuriously_retransmitted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(189usize, 58usize, 1usize);
        self.measure(190usize, 86usize, event.packet_len);
        self.count(191usize, 59usize, event.payload_len);
        self.measure(192usize, 87usize, event.payload_len);
        context
            .ctr_88
            .fetch_add(event.payload_len.as_u64(), Ordering::Relaxed);
        self.count_bool(194usize, 15usize, event.is_retransmission);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_max_data_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(195usize, 60usize, 1usize);
        self.count(196usize, 61usize, event.increase);
        self.measure(197usize, 89usize, event.increase);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_control_packet_transmitted(
        ...
        self.measure(199usize, 90usize, event.packet_len);
        self.measure(200usize, 91usize, event.control_data_len);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_control_packet_received(
        ...
        self.measure(202usize, 92usize, event.packet_len);
        self.measure(203usize, 93usize, event.control_data_len);
        self.count_bool(204usize, 16usize, event.is_authenticated);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_stream_receiver_errored(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(205usize, 64usize, 1usize);
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_connection_closed(
        ...
        self.measure(60usize, 16usize, context.ctr_16.load(Ordering::Relaxed));
        self.measure(64usize, 19usize, context.ctr_19.load(Ordering::Relaxed));
        self.measure(
            66usize,
            21usize,
            core::time::Duration::from_micros(context.ctr_21.load(Ordering::Relaxed)),
        );
        self.measure(69usize, 22usize, context.ctr_22.load(Ordering::Relaxed));
        self.measure(73usize, 25usize, context.ctr_25.load(Ordering::Relaxed));
        self.measure(
            75usize,
            27usize,
            core::time::Duration::from_micros(context.ctr_27.load(Ordering::Relaxed)),
        );
        self.measure(78usize, 28usize, context.ctr_28.load(Ordering::Relaxed));
        self.measure(
            81usize,
            31usize,
        ...
        self.measure(89usize, 35usize, context.ctr_35.load(Ordering::Relaxed));
        self.measure(91usize, 37usize, context.ctr_37.load(Ordering::Relaxed));
        self.measure(97usize, 39usize, context.ctr_39.load(Ordering::Relaxed));
        self.measure(101usize, 42usize, context.ctr_42.load(Ordering::Relaxed));
        self.measure(103usize, 43usize, context.ctr_43.load(Ordering::Relaxed));
        self.measure(109usize, 46usize, context.ctr_46.load(Ordering::Relaxed));
        self.measure(113usize, 49usize, context.ctr_49.load(Ordering::Relaxed));
        self.measure(
            115usize,
            51usize,
            core::time::Duration::from_micros(context.ctr_51.load(Ordering::Relaxed)),
        );
        self.measure(118usize, 52usize, context.ctr_52.load(Ordering::Relaxed));
        self.measure(
            121usize,
            55usize,
        ...
        self.measure(137usize, 62usize, context.ctr_62.load(Ordering::Relaxed));
        self.measure(141usize, 65usize, context.ctr_65.load(Ordering::Relaxed));
        self.measure(143usize, 66usize, context.ctr_66.load(Ordering::Relaxed));
        self.measure(165usize, 73usize, context.ctr_73.load(Ordering::Relaxed));
        self.measure(173usize, 77usize, context.ctr_77.load(Ordering::Relaxed));
        self.measure(179usize, 80usize, context.ctr_80.load(Ordering::Relaxed));
        self.measure(186usize, 84usize, context.ctr_84.load(Ordering::Relaxed));
        self.measure(193usize, 88usize, context.ctr_88.load(Ordering::Relaxed));
        let _ = context;
        let _ = meta;
        let _ = event;
    }
    ...
    fn on_endpoint_initialized(&self, meta: &api::EndpointMeta, event: &api::EndpointInitialized) {
        #[allow(unused_imports)]
        use api::*;
        self.count(208usize, 67usize, 1usize);
        self.count_nominal(209usize, 8usize, &event.acceptor_addr);
        self.count_nominal(210usize, 9usize, &event.handshake_addr);
        self.count_bool(211usize, 17usize, event.tcp);
        self.count_bool(212usize, 18usize, event.udp);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_dc_connection_timeout(&self, meta: &api::EndpointMeta, event: &api::DcConnectionTimeout) {
        #[allow(unused_imports)]
        use api::*;
        self.count(213usize, 68usize, 1usize);
    ...
    fn on_path_secret_map_initialized(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(215usize, 69usize, 1usize);
    ...
    fn on_path_secret_map_uninitialized(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(217usize, 70usize, 1usize);
        self.measure(218usize, 95usize, event.capacity);
        self.measure(219usize, 96usize, event.entries);
        self.measure(220usize, 97usize, event.lifetime);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_background_handshake_requested(
        ...
        self.count_nominal(222usize, 11usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_entry_inserted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(223usize, 72usize, 1usize);
        self.count_nominal(224usize, 12usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_entry_ready(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(225usize, 73usize, 1usize);
        self.count_nominal(226usize, 13usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_entry_replaced(
        ...
        self.count_nominal(228usize, 14usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_entry_evicted(
        ...
        self.measure(231usize, 98usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_entry_evicted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(232usize, 76usize, 1usize);
        self.count_nominal(233usize, 16usize, &event.peer_address);
        self.measure(234usize, 99usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_sent(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(235usize, 77usize, 1usize);
        self.count_nominal(236usize, 17usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(237usize, 78usize, 1usize);
        self.count_nominal(238usize, 18usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_unknown_path_secret_packet_accepted(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(239usize, 79usize, 1usize);
        self.count_nominal(240usize, 19usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    ...
    fn on_key_accepted(&self, meta: &api::EndpointMeta, event: &api::KeyAccepted) {
        ...
        self.measure(246usize, 100usize, event.gap);
        self.measure(247usize, 101usize, event.forward_shift);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_definitely_detected(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(248usize, 83usize, 1usize);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_potentially_detected(
        ...
        self.measure(250usize, 102usize, event.gap);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_sent(
        ...
        self.count_nominal(252usize, 22usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_received(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(253usize, 86usize, 1usize);
        self.count_nominal(254usize, 23usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_accepted(
        ...
        self.count_nominal(256usize, 24usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_rejected(
        ...
        self.count_nominal(258usize, 25usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_replay_detected_packet_dropped(
        ...
        self.count_nominal(260usize, 26usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_sent(&self, meta: &api::EndpointMeta, event: &api::StaleKeyPacketSent) {
        ...
        self.count_nominal(262usize, 27usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_received(
        ...
        self.count_nominal(264usize, 28usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_accepted(
        ...
        self.count_nominal(266usize, 29usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_rejected(
        ...
        self.count_nominal(268usize, 30usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_stale_key_packet_dropped(
        ...
        self.count_nominal(270usize, 31usize, &event.peer_address);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_cache_accessed(
        ...
        self.count_nominal(272usize, 32usize, &event.peer_address);
        self.count_bool(273usize, 19usize, event.hit);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_cache_accessed_hit(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(274usize, 96usize, 1usize);
        self.count_nominal(275usize, 33usize, &event.peer_address);
        self.measure(276usize, 103usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_cache_accessed(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(277usize, 97usize, 1usize);
        self.count_bool(278usize, 20usize, event.hit);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_cache_accessed_hit(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(279usize, 98usize, 1usize);
        self.measure(280usize, 104usize, event.age);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_cleaner_cycled(
        ...
        #[allow(unused_imports)]
        use api::*;
        self.count(281usize, 99usize, 1usize);
        self.measure(282usize, 105usize, event.id_entries);
        self.measure(283usize, 106usize, event.id_entries_retired);
        self.measure(284usize, 107usize, event.id_entries_active);
        self.measure(285usize, 108usize, event.id_entries_active_utilization);
        self.measure(286usize, 109usize, event.id_entries_utilization);
        self.measure(287usize, 110usize, event.id_entries_initial_utilization);
        self.measure(288usize, 111usize, event.address_entries);
        self.measure(289usize, 112usize, event.address_entries_active);
        self.measure(290usize, 113usize, event.address_entries_active_utilization);
        self.measure(291usize, 114usize, event.address_entries_retired);
        self.measure(292usize, 115usize, event.address_entries_utilization);
        self.measure(
            293usize,
            116usize,
            event.address_entries_initial_utilization,
        );
        self.measure(294usize, 117usize, event.handshake_requests);
        self.measure(295usize, 118usize, event.handshake_requests_skipped);
        self.measure(296usize, 119usize, event.handshake_lock_duration);
        self.measure(297usize, 120usize, event.duration);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_id_write_lock(
        ...
        self.measure(299usize, 121usize, event.acquire);
        self.measure(300usize, 122usize, event.duration);
        let _ = event;
        let _ = meta;
    }
    #[inline]
    fn on_path_secret_map_address_write_lock(
        ...
        self.measure(302usize, 123usize, event.acquire);
        self.measure(303usize, 124usize, event.duration);
        let _ = event;
        let _ = meta;
    }
}
