...
impl Map {
    ...
    ///
    /// For the B0 validation harness: stop the periodic cleaner so a manually driven
    ...
    ///
    /// For the B0 validation harness; call [`Map::stop_cleaner`] first so the background thread does
