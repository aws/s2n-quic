...
use super::{
    ...
    proactive_unknown_path_secret,
    stateless_reset, ApplicationData, ApplicationDataError, DiskEntry, Entry, SendStats, Store,
};
use crate::{
    ...
    S: event::Subscriber,
{
    ...
    fn insert_persisted(
        ...
        // map going live, so this check-then-insert races nothing.
