...
probe::define!(
    extern "probe" {
        ...
        #[link_name = s2n_quic_dc__flow__queue__receiver_free]
        pub fn on_receiver_free(queue_id: VarInt, owner: Half);

        /// Called when a sender is dropped for a queue
        #[link_name = s2n_quic_dc__flow__queue__sender_drop]
