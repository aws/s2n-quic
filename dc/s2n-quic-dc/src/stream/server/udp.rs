    ...
    W: socket::Socket,
{
    pub fn new(
        ...
        let credential_cache = create_credential_cache();
    ...
    W: socket::Socket,
{
    ...
    fn dispatch_stream_packet(
        ...
        let subscriber = self.env.subscriber().clone();
...
fn create_credential_cache() -> CredentialCache {
    use schnellru::RandomState;
    let limits = schnellru::ByLength::new(4096);
